    ...
    <div className="shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="ring-1 ring-gray-200 shadow-lg rounded-md px-2 py-1 tex-sm cursor-pointer hover:text-white hover:bg-black transition-all duration-300 flex items-center gap-2">
